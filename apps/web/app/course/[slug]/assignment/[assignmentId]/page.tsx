...
export default function AssignmentPage() {
  ...
  const assignment = assignmentData[assignmentKey as keyof typeof assignmentData];
      ...
      <Container size="lg">
        ...
        <Card shadow="sm" padding="lg" radius="md" withBorder mb="xl">
          <Group justify="space-between" mb="md">
            ...
            <Button variant="outline" onClick={() => router.push(`/course/${assignment.courseSlug}`)}>
              ← Back to Course
            </Button>
          </Group>
            ...
            {assignment.status === 'open' ? (
              <Card shadow="sm" padding="lg" radius="md" withBorder>
                ...
                <Stack gap="md">
                  ...
                  <Group justify="flex-end" mt="xl">
                    <Button 
                      variant="outline" 
                      onClick={() => router.push(`/course/${assignment.courseSlug}`)}
                    >
                      Cancel
                    </Button>
                    <Button 
              ...
              <Card shadow="sm" padding="lg" radius="md" withBorder>
                <Stack align="center" gap="md">
                  ...
                  <Button onClick={() => router.push(`/course/${assignment.courseSlug}`)}>
                    Return to Course
                  </Button>
                </Stack>
              </Card>
