...
export default function CoursePage() {
  ...
  const breadcrumbItems = [
    ...
    <Anchor key={index} onClick={() => item.href !== '#' && router.push(item.href)}>
      {item.title}
    </Anchor>
  ));
    ...
    <Box>
      ...
      <Paper shadow="sm" p="md" mb="lg">
        <Group justify="space-between">
          <div>
            ...
            <Text size="sm" c="dimmed">Manage your course content and assignments</Text>
          </div>
      ...
      <Container size="lg">
        ...
        <Card shadow="sm" padding="lg" radius="md" withBorder mb="xl">
          ...
          <Title order={1} mb="sm">{course.name}</Title>
          <Text size="lg" c="dimmed" mb="md">{course.description}</Text>
          
          <Group gap="xl">
            <div>
              <Text size="sm" fw={500}>Instructor</Text>
            ...
            <div>
              ...
              <Text size="sm">{course.students} enrolled</Text>
            </div>
          </Group>
        </Card>

        {/* Course Modules */}
        <Title order={2} mb="md">Course Modules</Title>
        ...
        <Accordion variant="separated" radius="md">
          {course.modules.map((module, index) => (
            <Accordion.Item key={module.id} value={module.id}>
              <Accordion.Control>
                <Group>
                  <Badge variant="light" color={course.color}>
                    Module {index + 1}
                  </Badge>
                  <div>
              ...
              <Accordion.Panel>
                <Stack gap="md">
                  {/* Lessons */}
                  <div>
                    <Text fw={500} mb="xs">📚 Lessons</Text>
                    <Stack gap="xs">
                      {module.lessons.map((lesson, lessonIndex) => (
                        <Paper key={lessonIndex} p="sm" withBorder>
                          <Text size="sm">{lessonIndex + 1}. {lesson}</Text>
                        </Paper>
                      ))}
                    </Stack>
                  </div>
                  ...
                  {/* Assignments */}
                  <div>
                    <Text fw={500} mb="xs">📝 Assignments</Text>
                    <Stack gap="xs">
                      {module.assignments.map((assignment, assignmentIndex) => (
                        <Paper 
                          ...
                          onClick={() => router.push(`/course/${slug}/assignment/${assignment.id}`)}
                        >
                          <Group justify="space-between">
